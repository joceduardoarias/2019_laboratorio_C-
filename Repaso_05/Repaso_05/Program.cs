...
namespace Repaso_05
{
    class Program
    {
        ...
        {
            // Creo un estante Estante
            Estante estante;
            estante = new Estante(3, 1);
            // Creo 4 productos
            Producto p1;
            Producto p2;
            Producto p3;
            Producto p4;
            p1 = new Producto("Pepsi", "PESDS97413", (float)18.5);
            p2 = new Producto("Coca-Cola", "COSDS55752", (float)11.5);
            p3 = new Producto("Manaos", "MASDS51292", (float)20.5);
            p4 = new Producto("Crush", "CRSDS54861", (float)10.75);
